...
# Timing: composite_curve.rate(dt(2022, 6, 1), "1y", approximate=True)
import timeit
print('Timing:', timeit.timeit(lambda: composite_curve.rate(dt(2022, 6, 1), "1y", approximate=True), number=1000))


# Timing: composite_curve.rate(dt(2022, 6, 1), "1y", approximate=False)
import timeit
print('Timing:', timeit.timeit(lambda: composite_curve.rate(dt(2022, 6, 1), "1y", approximate=False), number=1000))
